								...
								<?php foreach ($pegawai_list as $key) { ?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url('pegawai/update/').$key->id ?>" onClick="show_confirm('update')" class="btn btn-warning"><i class="glyphicon glyphicon-edit"></i> Edit</a>
									    	<a href="<?php echo site_url('pegawai/delete/').$key->id ?>" onClick="show_confirm('hapus')" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i> Delete</a>
